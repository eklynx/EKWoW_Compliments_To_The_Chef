...
What is said can be easily changed in the add-on settings page, and every character has its own settings.

It's that simple!

Translations might not be entirely accurate, since they are based on Google Translate and AI assistance.  I welcome corrections or addition.  Please open up a GitHub issue with what things should be for a speficic localization. 

Please let me know if there are any issues on the Github page found at https://github.com/eklynx/EKWoW_Compliments_To_The_Chef
